...
from schemas.enums.model import OperationMethod, OperationObject
...
class User(TimestampMixin):
    ...
    role: fields.ManyToManyRelation["Role"] = fields.ManyToManyField("user.Role", related_name="user",
...
class Role(TimestampMixin):
    ...
    access: fields.ManyToManyRelation["Access"] = fields.ManyToManyField("user.Access", related_name="role",
                                                                         on_delete=fields.CASCADE)
...
class UserProfile(TimestampMixin):
    user: fields.OneToOneRelation[User] = fields.OneToOneField('user.User', related_name='profile')
